...
public class FireHandController : MageHandController {
	...
	// the tolerance angle of palm to be considered as facing up relative to the local y axis.
	[Range (0.0f, 20.0f)]
	public float palmFacingUpAngle = 15.0f;
	...
	//device meets the condidence level. If three conditions are met, then it is considered read to cast fire ball. 
